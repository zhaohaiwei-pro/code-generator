...
public class TableAttributeEntity implements Comparable<TableAttributeEntity> {
    ...
    public String toString() {
        return "TableAttributeEntity [tdCreate=" + tdCreate + ", tdColumnName=" + tdColumnName + ", tdJdbcType=" + tdJdbcType
            + ", tdJavaType=" + tdJavaType + ", tdField=" + tdField + ", nullable=" + nullable + ", columnDef=" + columnDef + ", remarks="
            + remarks + ", columnSize=" + columnSize + ", decimalDigits=" + decimalDigits + ", ordinalPosition=" + ordinalPosition + "]";
    }

    @Override
    public int compareTo(TableAttributeEntity obj) {
        return Integer.compare(ordinalPosition, obj.getOrdinalPosition());
    }
